"""
Django settings for claims_48093 project.
...
ROOT_URLCONF = 'claims_48093.urls'
...
WSGI_APPLICATION = 'claims_48093.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "claims_48093 API",
    "DESCRIPTION": "API documentation for claims_48093 App",
    "VERSION": "v1",
}
